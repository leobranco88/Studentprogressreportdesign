    ...
    <div className="space-y-4">
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-white rounded-2xl shadow-sm p-6 flex items-center justify-center">
          <QRCodeSVG 
            value="https://eic.escola.com.br/verify/leonardo-2026" 
            size={120}
            level="H"
            includeMargin={true}
          />
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6">
          ...
          <div className="text-sm font-semibold text-[#070738]">Ana Costa</div>
          <div className="text-xs text-[#9CA3AF]">Coordenadora Pedagógica</div>
        </div>
